...
public class Consts {
    ...
    /**
     * The speed at which a students moves. Should always be positive.
     */ 
    ...
    // =================================
    /** 
     * The width of the accommodation texture.
     */
    ...
    /** 
     * The cost of maintaining. Every period of time the maintenance
     * cost of the building is deducted from the players money.
     */
    public static final int ACCOMMODATION_MAINTENANCE_L1 = 50;
    /** 
     * The initial cost of building the building.
     */
